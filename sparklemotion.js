(function (_, Kotlin, $module$kotlinx_serialization_kotlinx_serialization_runtime, $module$kotlinx_coroutines_core, $module$klock_root_klock, $module$kgl, $module$react_dom, $module$kotlinx_html_js, $module$three, $module$js_mapper_index_jsx, $module$kotlin_extensions, $module$react, $module$threejs_wrapper, $module$js_FakeClientDevice_jsx, $module$js_app_index_jsx) {
  'use strict';
  ...
  function main(args) {
    ...
    switch (mode) {
      ...
      case 'Mapper':
        ...
        break;
      case 'UI':
        var network_0 = new BrowserNetwork();
        var pinkyAddress_0 = new BrowserNetwork$BrowserAddress(websocketsUrl());
        var uiApp = new WebUi(network_0, pinkyAddress_0);
        render(uiApp.render(), document.body);
        break;
      case 'test':
        break;
      default:throw UnsupportedOperationException_init_0('unknown mode ' + mode.toString());
    }
  }
  ...
  return _;
}(module.exports, require('kotlin'), require('kotlinx-serialization-kotlinx-serialization-runtime'), require('kotlinx-coroutines-core'), require('klock-root-klock'), require('kgl'), require('react-dom'), require('kotlinx-html-js'), require('three'), require('js/mapper/index.jsx'), require('kotlin-extensions'), require('react'), require('threejs-wrapper'), require('js/FakeClientDevice.jsx'), require('js/app/index.jsx')));
