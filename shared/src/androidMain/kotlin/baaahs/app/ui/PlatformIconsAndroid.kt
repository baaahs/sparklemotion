...
actual fun getCommonIcons(): PlatformIcons = object : PlatformIcons {
    ...
    override val Feed: Icon = FakeIcon
    override val Layout: Icon = FakeIcon
    override val Stream: Icon = FakeIcon
    ...
    override val DeveloperMode: Icon = FakeIcon
    override val DisplaySettings: Icon = FakeIcon
    override val EnterFullScreen get() = FakeIcon
    override val ExitFullScreen get() = FakeIcon
