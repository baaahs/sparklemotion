...
enum class TransformMode(val modeName: String, val icon: Icon) {
    Move("translate", PanTool) {
        ...
        override fun getGridSize(visualizer: BaseVisualizer.Facade): Double? =
            visualizer.moveSnap

        override fun setGridSize(visualizer: BaseVisualizer.Facade, value: Double?) {
    ...
    abstract fun getGridSize(visualizer: BaseVisualizer.Facade): Double?
    abstract fun setGridSize(visualizer: BaseVisualizer.Facade, value: Double?)
