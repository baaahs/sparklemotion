...
//        ObjModelData("A Panels", null, Matrix4F.identity, "decom-2019-panels.obj", true),
        ObjModelData("B Panels", null,
            Matrix4F.fromPositionAndRotation(Vector3F(170f, 0f, 0f), EulerAngle(1.0, .5, .25))
            , "decom-2019-panels.obj", true),
...
val demoModelMetadata = ConstEntityMetadataProvider(16 * 60)