...
//        }
//
//        controllerListener.onChange(fixturesToAdd, fixturesToRemove)
...
//    }
    ...
    // This message was never implemented in the brain controller software, so don't bother with this.
    private fun maybeSendBrainMappingMessage(
        fixture: Fixture,
        msg: BrainHelloMessage,
        brainId: BrainId,
        brainAddress: Network.Address
