...
class AnglesShader : Shader<AnglesShader.Buffer>(ShaderId.HEART) {
    ...
    companion object : ShaderReader<AnglesShader> {
        override fun parse(reader: ByteArrayReader) = AnglesShader()
    }

    inner class Buffer : Shader.Buffer {
        override val shader: Shader<*> get() = this@AnglesShader
