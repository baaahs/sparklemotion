...
external open class XRSystem : XRSystem, EventTarget {
...
external open class XRViewport : XRViewport {
    open val x: Number
    open val y: Number
...
external open class XRSpace : XRSpace, EventTarget {
    open fun addEventListener(type: String, listener: EventListener?, options: Boolean = definedExternally)
    open fun addEventListener(type: String, listener: EventListener?)
    open fun addEventListener(type: String, listener: EventListener?, options: AddEventListenerOptions = definedExternally)
    open fun addEventListener(type: String, listener: EventListenerObject?, options: Boolean = definedExternally)
...
external open class XRRenderState : XRRenderState {
...
external open class XRReferenceSpaceEvent(type: String /* "reset" */, eventInitDict: XRReferenceSpaceEventInit = definedExternally) : XRReferenceSpaceEvent, Event {
...
external open class XRReferenceSpace : XRReferenceSpace {
    open fun addEventListener(type: String, listener: EventListener?, options: Boolean = definedExternally)
    open fun addEventListener(type: String, listener: EventListener?)
    open fun addEventListener(type: String, listener: EventListener?, options: AddEventListenerOptions = definedExternally)
    open fun addEventListener(type: String, listener: EventListenerObject?, options: Boolean = definedExternally)
...
external open class XRBoundedReferenceSpace : XRBoundedReferenceSpace {
    open fun getOffsetReferenceSpace(originOffset: XRRigidTransform): XRReferenceSpace
    open var onreset: XRReferenceSpaceEventHandler
    open fun <K : String> addEventListener(type: K, listener: (self: XRReferenceSpace, ev: Any) -> Any, options: Boolean = definedExternally)
    open fun <K : String> addEventListener(type: K, listener: (self: XRReferenceSpace, ev: Any) -> Any)
...
external open class XRInputSource : XRInputSource {
...
external open class XRInputSourceArray : XRInputSourceArray {
    @nativeGetter
...
external open class XRPose : XRPose {
    open val transform: XRRigidTransform
...
external open class XRFrame : XRFrame {
...
external open class XRInputSourceEvent(type: String /* "select" | "selectend" | "selectstart" | "squeeze" | "squeezeend" | "squeezestart" */, eventInitDict: XRInputSourceEventInit = definedExternally) : Event {
...
external open class XRSessionEvent(type: String /* "end" | "visibilitychange" | "frameratechange" */, eventInitDict: XRSessionEventInit = definedExternally) : Event {
    open val session: XRSession
}
...
external open class XRSession : XRSession, EventTarget {
...
external open class XRViewerPose : XRViewerPose {
    open val transform: XRRigidTransform
    open val linearVelocity: DOMPointReadOnly?
    open val angularVelocity: DOMPointReadOnly?
    open val emulatedPosition: Boolean
...
external open class XRRigidTransform(position: DOMPointInit = definedExternally, direction: DOMPointInit = definedExternally) {
...
external open class XRView : XRView {
...
external open class XRAnchor : XRAnchor {
...
external open class XRTransientInputHitTestResult {
    open val inputSource: XRInputSource
    open val results: Array<XRHitTestResult>
    open var prototype: XRTransientInputHitTestResult
}

external open class XRHitTestResult : XRHitTestResult {
    open fun getPose(baseSpace: XRSpace): XRPose?
    open var createAnchor: ((pose: XRRigidTransform) -> Promise<XRAnchor>?)?
}

external open class XRHitTestSource : XRHitTestSource {
    open fun cancel()
}

external open class XRTransientInputHitTestSource : XRTransientInputHitTestSource {
    open fun cancel()
}
...
external open class XRPlane : XRPlane {
...
external open class XRMesh : XRMesh {
...
external open class XRJointSpace : XRJointSpace {
    open fun addEventListener(type: String, listener: EventListener?, options: Boolean = definedExternally)
    open fun addEventListener(type: String, listener: EventListener?)
    open fun addEventListener(type: String, listener: EventListener?, options: AddEventListenerOptions = definedExternally)
    open fun addEventListener(type: String, listener: EventListenerObject?, options: Boolean = definedExternally)
...
external open class XRJointPose : XRJointPose {
    open val transform: XRRigidTransform
    open val linearVelocity: DOMPointReadOnly?
    open val angularVelocity: DOMPointReadOnly?
    open val emulatedPosition: Boolean
...
external open class XRHand : XRHand, Map<String /* "wrist" | "thumb-metacarpal" | "thumb-phalanx-proximal" | "thumb-phalanx-distal" | "thumb-tip" | "index-finger-metacarpal" | "index-finger-phalanx-proximal" | "index-finger-phalanx-intermediate" | "index-finger-phalanx-distal" | "index-finger-tip" | "middle-finger-metacarpal" | "middle-finger-phalanx-proximal" | "middle-finger-phalanx-intermediate" | "middle-finger-phalanx-distal" | "middle-finger-tip" | "ring-finger-metacarpal" | "ring-finger-phalanx-proximal" | "ring-finger-phalanx-intermediate" | "ring-finger-phalanx-distal" | "ring-finger-tip" | "pinky-finger-metacarpal" | "pinky-finger-phalanx-proximal" | "pinky-finger-phalanx-intermediate" | "pinky-finger-phalanx-distal" | "pinky-finger-tip" */, XRJointSpace> {
    open fun clear()
...
external open class XRLayer : XRLayer, EventTarget {
    open fun addEventListener(type: String, listener: EventListener?, options: Boolean = definedExternally)
    open fun addEventListener(type: String, listener: EventListener?)
    open fun addEventListener(type: String, listener: EventListener?, options: AddEventListenerOptions = definedExternally)
    open fun addEventListener(type: String, listener: EventListenerObject?, options: Boolean = definedExternally)
...
external open class XRWebGLLayer : XRLayer {
...
external open class XRCompositionLayer : XRCompositionLayer {
    open fun addEventListener(type: String, listener: EventListener?, options: Boolean = definedExternally)
    open fun addEventListener(type: String, listener: EventListener?)
    open fun addEventListener(type: String, listener: EventListener?, options: AddEventListenerOptions = definedExternally)
    open fun addEventListener(type: String, listener: EventListenerObject?, options: Boolean = definedExternally)
...
external open class XRProjectionLayer : XRProjectionLayer {
    open val layout: String /* "default" | "mono" | "stereo" | "stereo-left-right" | "stereo-top-bottom" */
    open var blendTextureSourceAlpha: Boolean
    open var chromaticAberrationCorrection: Boolean?
    open val mipLevels: Number
...
external open class XRCylinderLayer : XRCylinderLayer {
    open val layout: String /* "default" | "mono" | "stereo" | "stereo-left-right" | "stereo-top-bottom" */
    open var blendTextureSourceAlpha: Boolean
    open var chromaticAberrationCorrection: Boolean?
    open val mipLevels: Number
...
external open class XRQuadLayer : XRQuadLayer {
    open val layout: String /* "default" | "mono" | "stereo" | "stereo-left-right" | "stereo-top-bottom" */
    open var blendTextureSourceAlpha: Boolean
    open var chromaticAberrationCorrection: Boolean?
    open val mipLevels: Number
...
external open class XREquirectLayer : XREquirectLayer {
    open val layout: String /* "default" | "mono" | "stereo" | "stereo-left-right" | "stereo-top-bottom" */
    open var blendTextureSourceAlpha: Boolean
    open var chromaticAberrationCorrection: Boolean?
    open val mipLevels: Number
...
external open class XRCubeLayer : XRCubeLayer {
    open val layout: String /* "default" | "mono" | "stereo" | "stereo-left-right" | "stereo-top-bottom" */
    open var blendTextureSourceAlpha: Boolean
    open var chromaticAberrationCorrection: Boolean?
    open val mipLevels: Number
...
external open class XRSubImage : XRSubImage {
    open val viewport: XRViewport
}

external open class XRWebGLSubImage : XRWebGLSubImage {
    open val viewport: XRViewport
...
external open class XRWebGLBinding(session: XRSession, context: WebGLRenderingContext) {
...
external open class OVR_multiview2
...
external open class OCULUS_multiview : OCULUS_multiview {
